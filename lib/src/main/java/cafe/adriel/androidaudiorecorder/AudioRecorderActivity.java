...
import wiseowl.com.au.reaction.AndroidAudioRecorder;
...
public class AudioRecorderActivity extends AppCompatActivity implements PullTransport.OnAudioChunkPulledListener, MediaPlayer.OnCompletionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            ...
            question = savedInstanceState.getString(AndroidAudioRecorder.EXTRA_QUESTION);
            ...
            question = getIntent().getStringExtra(AndroidAudioRecorder.EXTRA_QUESTION);
